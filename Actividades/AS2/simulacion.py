...
class Simulacion:
    ...
    def nuevo_dia(self) -> None:
        recolector_1 = Recolector("Héctor", self.centro_urbano)
        recolector_2 = Recolector("Matías", self.centro_urbano)
        trabajador_1 = Constructor("Almendra", self.centro_urbano)
        trabajador_2 = Constructor("Cassandra", self.centro_urbano)
        recolector_1.start()
        recolector_2.start()
        trabajador_1.start()
        trabajador_2.start()
